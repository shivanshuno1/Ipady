...
# Use a raw string for the .env file path to avoid escape sequence errors
dotenv_path = r"C:\\Users\\91828\\Desktop\\web-development\\NODE JS\\project-ai\\cal-by\\apps\\calculator\\.env"
...
if GEMINI_API_KEY is None:
    print("Error: GEMINI_API_KEY is not found in the .env file or is empty.")
else:
